...
def test_sort_by_date_ascending(sample_data):
    ...
    expected_dates = ["2022-06-30T02:08:58.425572", "2024-09-12T21:27:25.241689", "2026-07-03T18:35:29.512364"]
...
def test_sort_by_date_descending(sample_data):
    ...
    dates = [item["date"] for item in result]
    expected_dates = ["2026-07-03T18:35:29.512364", "2024-09-12T21:27:25.241689", "2022-06-30T02:08:58.425572"]
    assert dates == expected_dates
